 ...
 */
#ifndef ESP8266_WEB_FASTLED_MUSIC_SOCKETEVENTHANDLER_H
#define ESP8266_WEB_FASTLED_MUSIC_SOCKETEVENTHANDLER_H
...
protected:
    ...
    static void handleSetColorOptionEvent(JsonVariant &payload, Response &response);
...
#endif //ESP8266_WEB_FASTLED_MUSIC_SOCKETEVENTHANDLER_H
