...
void BlendwaveAnimation::animate(CRGB *strip) {
    uint8_t bpm1 = getLimitedByteOption("bpm1", 6, 1);
    uint8_t bpm2 = getLimitedByteOption("bpm2", 10, 1);
    uint8_t bright = getLimitedByteOption("bright", 6);
    uint8_t sat = getLimitedByteOption("sat", 6);
